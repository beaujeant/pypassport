...
class PACE:
    ...
    def __init__(self, iso7816, mrz=None, can=None, password: bytes | None = None):
    ...
    def perform_pace(self, algorithm_oid: bytes, pw_ref: bytes, domain_params: bytes = b"", chat: bytes = b"") -> None:
        """
    ...
    def _calc_auth_token(self, k_mac: bytes, algorithm_oid: list, pk: bytearray) -> bytearray:
        ...
        return bytearray(self.get_cmac(k_mac, bytearray(mac_input)))[:8]
