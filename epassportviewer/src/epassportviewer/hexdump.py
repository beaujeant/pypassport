...
def build_legend(parent, fields=LEGEND_ORDER):
    ...
    for field in fields:
        # Force dark text: the default label foreground can be a low-contrast
        # grey that is hard to read on these pale swatch colours.
        tk.Label(
            legend,
            text=field,
            background=FIELD_COLORS[field],
...
class HexDumpView:
    ...
    def __init__(self, parent, height=10):
        ...
        self._text.tag_configure("offset", foreground=theme.TEXT_MUTED)
