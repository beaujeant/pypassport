...
class PlaceholderEntry(ttk.Entry):
    ...
    def __init__(self, parent, placeholder, *args, **kwargs):
        ...
        self.placeholder_color = theme.TEXT_DISABLED
        self.default_color = theme.TEXT

        self._textvariable: tk.Variable | None = kwargs.get("textvariable")
        self._placeholder_var = tk.StringVar(master=self)
    ...
    def set_invalid(self, invalid: bool) -> None:
        """Toggle the red invalid border while keeping placeholder behavior intact."""
    ...
    def _show_placeholder(self, event=None):
        ...
        if self._textvariable is not None:
            ...
            self.configure(textvariable=self._placeholder_var)
    ...
    def _on_var_write(self, *args):
        ...
        if self._is_placeholder and textvariable is not None and textvariable.get():
